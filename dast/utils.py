...
def extract_fingerprint(headers: dict, body: str) -> dict[str, str]:
    """Extract technology fingerprint from response.
    ...
    if "react" in body_lower and "reactroot" in body_lower:
        tech["frontend"] = "react"
    elif "vue" in body_lower and "vuedata" in body_lower:
        tech["frontend"] = "vue"
    elif "angular" in body_lower and "ng-app" in body_lower:
